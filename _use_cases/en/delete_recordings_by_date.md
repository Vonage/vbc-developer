...
Once we get a list of call recordings, we will loop though each recording delete it. Before doing this, make sure you have a backup of the recordings. Take a look at the [Delete Recordings by Date](/use-cases/call-recording-to-s3) use case to save recordings to Amazon S3.
